...
const stages = [
  ...
  },
  {
    ...
    text: "ვიზიტი არ სრულდება მანიპულაციის დასრულებით. ჩვენ უზრუნველყოფთ პაციენტის მდგომარეობის დინამიკურ დაკვირვებას ინტერვენციის შემდგომ პერიოდში, რათა გამოირიცხოს ნებისმიერი გვერდითი რეაქცია.",
  },
];
